...
function Card({ image, title, text, job, alt, addClass, addAnimation }) {
  return (
    <div
      className={`card static w-72 h-72 mx-auto flex flex-col justify-center items-center text-center text-xs space-y-4 text-slate-800 bg-white border-2 border-[#f7f9ff] shadow-lg shadow-[#e8edfd] rounded-lg md:font-normal sm:w-80 lg:text-sm ${addAnimation} ${addClass}`}>
